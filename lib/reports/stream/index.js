...
if ( io != undefined ) {
	...
	io.sockets.on('connection', function (socket) {
		...
		// when client request getStreams:
		
		//var kurunt = new Kurunt;

		//kurunt.getStreams(function (streams) {
		//	console.log('stream@reports, kurunt> ' + util.inspect(streams, true, 99, true));
		//}); 
