...
module.exports.work = function (message, wk, fn, callback) {
	...
	// clone object using JSON (Date wont parse), faster than deep clone functions.
	//var message = (JSON.parse(JSON.stringify(xmessage)));	
	//var Mbuffer = new Buffer(message.message);		
