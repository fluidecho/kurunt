...
if ( $h ne '' || $help ne '' ) {
	...
	print "For example> perl benchmark.pl -T=tcp -P=6001 -m=100 -c=10\n";
	print "This example would send 100 messages every second for 10 seconds through port 6001, -H (host)\n";
	exit(0);
}
if ( $P eq '' ) {
