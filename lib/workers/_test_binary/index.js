//
// Kurunt Test JPEG Worker
//
// Testing JPEG images for Kurunt.
// Version: 0.2
...
function _load(topology, workerid) {
	...
	//
	// See Kurunt: 		http://docs.kurunt.com/schemas/test_binary
	

	console.log(nodeID + 'test_binary@workers> loaded');
	loaded = true; 


	setInterval(function () {		

		console.log(nodeID + 'test_binary@workers> mps: ' + mps + ' n: ' + n);
		//console.log('BLAH!!!');	
...
/*
		...
		*/
		...
		//console.log('message.message> ' + util.inspect(message.message, true, 99, true));

		var image = message.message;																											// 
	...
	attr_values['image'] = image;																					// add image binary values to this attribute value, which get's added to the stores schema.
