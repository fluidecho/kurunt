...
module.exports.work = function (message, config, fn, callback) {
  ...
  //
  // See: http://docs.kurunt.com/workers/combined/
  ...
  try {
    ...
    var access_log = message.message.toString(config['encoding']);
    ...
    //values[0] = "973911bef1beb05bf55685fbe138741e";
    //values[1] = "127.0.0.1";
    //values[2] = "-";
    //values[3] = "frank";        
    ...
    // add values to this attribute, which get's added to this messages: stores: schema.
    var attributes = [];
